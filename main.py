...
ga = GA(
    ...
    n_poly=100,
    n_vertex=3,
    random_init_color=False,                             # If False, initialize the color of each polygon based on the average pixel values of the target image. If True, the intial colors are assigned randomly.  
    ...
    crossover_type=[crossover.OnePointCrossover(),crossover.ArithmeticCrossover()],      # crossover.OnePointCrossover(), crossover.UniformCrossover(), crossover.ArithmeticCrossover()
